...
if(g.game.vars.gameState.score == 9500 & time>0){
	g.game.vars.gameState.score = g.game.vars.gameState.score + Math.floor(time) + 500;
...
if(g.game.vars.gameState.score == 9500 & time <=0){
	g.game.vars.gameState.score = g.game.vars.gameState.score + 500;
	score_label.text="　 神　　　　 "+Math.floor(g.game.vars.gameState.score)+"点";
	score_label.x=536;
	score_label.fontSize=60;
	score_label.textColor=  "red";
